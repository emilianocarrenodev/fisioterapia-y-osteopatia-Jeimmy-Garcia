        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-4 wow slideInRight" data-wow-delay="0.5s">
                    <p><?= ($lang)? 'CONSULTORIO' : 'CONSULTORI' ?><br>
                        Passatge Marimon 7 principal primera Barcelona - España</p>
                    <p><?= ($lang)? 'CONTÁCTO' : 'CONTACTE' ?><br>
                        <?= ($lang)? 'Fijo' : 'Fixe' ?>: <a href="tel:+34932094435" target="_self">+34 932 09 44 35</a><br>
                        <?= ($lang)? 'Movil' : 'Mòvil' ?>: <a href="tel:+34620243225" target="_self">+34 620 243 225</a><br>
