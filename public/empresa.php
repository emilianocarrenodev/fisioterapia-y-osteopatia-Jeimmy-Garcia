        ...
        <div class="container">
            ...
            <div class="row mt-0 mt-lg-5">
                <div class="col-12 col-lg-4 pr-lg-5 wow slideInLeft" data-wow-delay="0.5s">
                    <div class="content-image bg-pl" style="background-image: url('./assets/img/jeimmy y viviana 3.jpg');"></div>
                </div>
            ...
            <div class="row mt-0 mt-lg-5 flex-column-reverse flex-lg-row">
                <div class="col-12 col-lg-8 pt-120 wow slideInLeft" data-wow-delay="0.5s">
                    ...
                    <p class="text-center"><b class="h5 font-weight-bold">Viviana Acuña</b></p>
                    <p><?= ($lang)? "Fisioterapeuta y Osteópata D.O, apasionada y enamorada de su profesión. Ha realizado formaciones dentro de la osteopatía del embarazo y la ginecología, tratamiento osteopático infantil, terapia respiratoria en bebés y adultos, osteopatía pediátrica, técnicas para la manipulación de tejidos de alta velocidad (SAT), mareos y problemas del sistema vestibular , clínica del terapeuta con casos clínicos y ayudar a encontrar el equilibrio entre el cuerpo y su naturaleza." : "Fisioterapèuta i Osteopata D.O, apassionada i enamorada de la seva professió. Ha realitzat formacions dins de la osteopatia de l'embaràs i la ginecologia, tractament osteopàtic infantil, teràpia respiratòria en nadons i adults, osteopatia pediátrica, tècniques per a la manipulació de teixits d'alta velocitat (SAT), marejos i problemes del sistema vestibular, clínica del terapeuta amb casos clínics i ajudar a trobar l'equilibri entre el cos i la seva naturalesa." ?></p>
                </div>
