        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5 pr-lg-0">
                    <div class="content-image" style="background-image: url('./assets/img/image-treatments-2.png');"></div>
                    ...
                    <img src="./assets/img/image-physiotherapy-treatments-2.png" class="img-fluid">
                </div>
                <div class="col-12 col-lg-7 bg-main mt-5 pt-0 pt-lg-3">
                    ...
                    <div class="container-p-main type-two">
